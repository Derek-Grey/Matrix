...
def generate_all_data(start_date='2024-01-02', end_date='2024-12-31', 
    ...
    # 保存到CSV
    daily_weights_df.to_csv('csv_folder/test_daily_weight.csv', index=False)
    daily_returns_df.to_csv('csv_folder/test_daily_return.csv', index=False)
    minute_weights_df.to_csv('csv_folder/test_minute_weight.csv', index=False)
    minute_returns_df.to_csv('csv_folder/test_minute_return.csv', index=False)
